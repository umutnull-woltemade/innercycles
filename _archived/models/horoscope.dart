...
class DailyHoroscope {
  ...
  final int
  energyLevel; // 1-5 (for UI display only, represents thematic intensity)
  ...
  factory DailyHoroscope.fromJson(Map<String, dynamic> json) => DailyHoroscope(
    ...
    focusNumber:
        json['focusNumber'] as String? ?? json['luckyNumber'] as String? ?? '',
    reflectionColor:
    ...
    futureIntention:
        json['futureIntention'] as String? ??
        json['futureGuidance'] as String? ??
        '',
    dailyTheme:
        json['dailyTheme'] as String? ?? json['cosmicMessage'] as String? ?? '',
  );
}
