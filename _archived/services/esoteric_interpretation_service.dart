...
class EsotericInterpretationService {
  ...
  static String getSunInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
...
''',
    ...
    return _getLocalizedInterpretation(
      'sun',
      sign.name,
      fallback,
      language: language,
  ...
  static String getMoonInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getRisingInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getMercuryInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getVenusInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getMarsInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getPlanetInHouseInterpretation(
    Planet planet,
    int houseNumber, {
    AppLanguage language = AppLanguage.tr,
  }) {
  ...
  static String getJupiterInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getSaturnInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getUranusInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getNeptuneInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
...
''',
  ...
  static String getPlutoInterpretation(
    ZodiacSign sign, {
    AppLanguage language = AppLanguage.tr,
  }) {
    final interpretations = {
