...
class LifePathMegaContent {
  ...
  final String planet;
  final String tarotMajorArcana;
  final String runicSymbol;
  final List<String> colors;
  final List<String> crystals;
  final String chakraAlignment;
  ...
  final String tantricEnergySignature;
  ...
  final Map<String, String> yearlyGuidance;

  const LifePathMegaContent({
    ...
    required this.tarotMajorArcana,
    required this.runicSymbol,
    ...
    required this.deepSpiritualMeaning,
    required this.karmicLessons,
    required this.pastLifeConnections,
    required this.soulPurpose,
    required this.shadowAspects,
    required this.tantricEnergySignature,
    required this.sacredGeometryConnection,
    required this.kundaliniActivation,
    required this.compatibilityMatrix,
    required this.soulMateNumbers,
    required this.karmicPartnerNumbers,
    required this.challengingNumbers,
    required this.careerDestiny,
    required this.healthTendencies,
    required this.wealthVibration,
    required this.loveAndRelationships,
    required this.famousExamples,
    required this.dailyAffirmations,
    required this.meditationMantras,
    required this.healingPractice,
    required this.yearlyGuidance,
  });
}
...
''',
  ...
  soulMateNumbers: [2, 6, 9],
  karmicPartnerNumbers: [4, 8],
...
''',
  ...
  soulMateNumbers: [1, 6, 9],
  karmicPartnerNumbers: [5, 7],
...
''',
  ...
  soulMateNumbers: [2, 6, 8],
  karmicPartnerNumbers: [3, 5],
...
''',
  ...
  soulMateNumbers: [1, 7, 9],
  karmicPartnerNumbers: [4, 6],
...
''',
  ...
  soulMateNumbers: [2, 3, 9],
  karmicPartnerNumbers: [1, 5],
...
''',
  ...
  soulMateNumbers: [9, 11],
  karmicPartnerNumbers: [3, 6],
...
class ExpressionNumberContent {
  ...
  final String outerPersonality;
  final String namePowerAnalysis;
  final String manifestationEnergy;
  final String creativeExpressionPath;
  final String careerExpression;
  final List<String> keywords;

  const ExpressionNumberContent({
    required this.number,
    required this.title,
    required this.vibration,
    required this.outerPersonality,
    required this.namePowerAnalysis,
    required this.manifestationEnergy,
    required this.creativeExpressionPath,
    required this.careerExpression,
...
class SoulUrgeContent {
  final int number;
  final String title;
  final String heartDesire;
  final String hiddenMotivations;
  final String spiritualCalling;
  final String innerWorldDynamics;
  final String deepestFear;
  final String healingPath;
  final List<String> soulKeywords;

  const SoulUrgeContent({
    required this.number,
    required this.title,
    required this.heartDesire,
    required this.hiddenMotivations,
    required this.spiritualCalling,
    required this.innerWorldDynamics,
    required this.deepestFear,
    required this.healingPath,
    required this.soulKeywords,
  });
}
...
class KarmicDebtContent {
  final int number;
  final String title;
  final String pastLifeDebt;
  final String lessonsToLearn;
  final String redemptionPath;
  final String healingPractices;
  final String shadowManifestations;
  final String breakingThePattern;
  final List<String> warningSign;

  const KarmicDebtContent({
    required this.number,
    required this.title,
    required this.pastLifeDebt,
    required this.lessonsToLearn,
    required this.redemptionPath,
    required this.healingPractices,
    required this.shadowManifestations,
    required this.breakingThePattern,
...
class PersonalYearContent {
  ...
  final Map<int, String> monthlyGuidance;
  ...
  const PersonalYearContent({
    ...
    required this.spiritualFocus,
    this.monthlyGuidance = const {},
  });
}
