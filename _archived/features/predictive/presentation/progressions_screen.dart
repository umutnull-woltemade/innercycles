...
class _ProgressionsScreenState extends ConsumerState<ProgressionsScreen> {
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  L10nService.get(
                    'screens.progressions.profile_not_found',
                    language,
                  ),
                  style: Theme.of(
                    context,
                ...
                Text(
                  L10nService.get(
                    'screens.progressions.enter_birth_info',
                    language,
                  ),
                  style: Theme.of(
                    context,
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    L10nService.get('screens.progressions.go_back', language),
                  ),
                ),
              ],
            ),
                      ...
                      if (_progressions != null) ...[
                        ...
                        KadimNotCard(
                          ...
                          title: L10nService.get(
                            'screens.progressions.kadim_title',
                            language,
                          ),
                          content: L10nService.get(
                            'screens.progressions.kadim_content',
                            language,
                          ),
                        ...
                        Text(
                          L10nService.get(
                            'screens.progressions.calculating',
                            language,
                          ),
                          style: TextStyle(
                            color: isDark
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(
            ...
            L10nService.get('screens.progressions.name', language),
            userProfile.name ??
                L10nService.get('screens.progressions.user', language),
          ),
          _buildInfoRow(
            isDark,
            Icons.cake_outlined,
          ...
          _buildInfoRow(
            ...
            L10nService.get('sun_sign', language),
  ...
  Widget _buildProgressedPositions(
    bool isDark,
    UserProfile userProfile,
    AppLanguage language,
  ) {
      ...
      child: Column(
        children: [
          ...
          if (hasChanged) ...[
            ...
            Text(
              L10nService.get(
                'screens.progressions.from',
                language,
              ).replaceAll('{sign}', natal.localizedName(language)),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                L10nService.get(
                  'screens.progressions.current_life_phase',
                  language,
                ),
                style: Theme.of(
                  context,
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                L10nService.get(
                  'screens.progressions.emotional_theme',
                  language,
                ),
                style: Theme.of(
                  context,
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                L10nService.get(
                  'screens.progressions.identity_evolution',
                  language,
                ),
                style: Theme.of(
                  context,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          aspect.isApplying
                              ? L10nService.get(
                                  'screens.progressions.applying',
                                  language,
                                )
                              : L10nService.get(
                                  'screens.progressions.separating',
                                  language,
                                ),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                L10nService.get(
                  'screens.progressions.significant_events',
                  language,
                ),
                style: Theme.of(
                  context,
