  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, size: 64, color: isDark ? AppColors.textMuted.withValues(alpha: 0.4) : AppColors.lightTextMuted.withValues(alpha: 0.4)),
          const SizedBox(height: AppConstants.spacingLg),
          Text(
            isEn ? titleEn : titleTr,
            textAlign: TextAlign.center,
            style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w700, color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary),
          ),
          const SizedBox(height: AppConstants.spacingMd),
          Text(
            isEn ? descriptionEn : descriptionTr,
            textAlign: TextAlign.center,
            style: GoogleFonts.inter(fontSize: 14, height: 1.5, color: isDark ? AppColors.textSecondary : AppColors.lightTextSecondary),
          ),
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Text('$currentEntries / $requiredEntries', style: TextStyle(fontSize: 12, color: isDark ? AppColors.textMuted : AppColors.lightTextMuted)),
                ],
              ),
            ),
          ],
          ...
          if (onStartTemplate != null)
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(isEn ? 'Start with Template' : 'Sablonla Basla', style: const TextStyle(fontWeight: FontWeight.w600)),
              ),
            ),
          if (onSeeExample != null) ...[
            ...
            TextButton(
              ...
              child: Text(isEn ? 'See Example' : 'Ornek Gor', style: TextStyle(color: isDark ? AppColors.textSecondary : AppColors.lightTextSecondary)),
            ),
          ],
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.auto_awesome, size: 56, color: AppColors.starGold)
              .animate().scale(begin: const Offset(0.5, 0.5), end: const Offset(1.0, 1.0), duration: 600.ms, curve: Curves.elasticOut),
          const SizedBox(height: AppConstants.spacingLg),
          Text(
            isEn ? headlineEn : headlineTr,
            textAlign: TextAlign.center,
            style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w700, color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary),
          ...
          if (impactTextEn != null) ...[
            ...
            Text(
              ...
              textAlign: TextAlign.center,
              style: GoogleFonts.inter(fontSize: 14, color: isDark ? AppColors.textSecondary : AppColors.lightTextSecondary, height: 1.5),
          ...
          ...actions.asMap().entries.map((entry) {
            ...
            ).animate().fadeIn(delay: Duration(milliseconds: 400 + index * 100), duration: 400.ms);
          }),
        ],
      ),
    );
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(isEn ? titleEn : titleTr, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary)),
        ...
        ...actions.asMap().entries.map((entry) {
          ...
          ).animate().fadeIn(delay: Duration(milliseconds: 100 + index * 80), duration: 400.ms);
        }),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text(widget.isEn ? 'Was this useful?' : 'Bu faydali oldu mu?', style: GoogleFonts.inter(fontSize: 13, color: widget.isDark ? AppColors.textSecondary : AppColors.lightTextSecondary)),
          const SizedBox(width: AppConstants.spacingMd),
          _buildFeedbackButton(Icons.thumb_up_outlined, Icons.thumb_up, true, AppColors.success),
          const SizedBox(width: AppConstants.spacingSm),
          _buildFeedbackButton(Icons.thumb_down_outlined, Icons.thumb_down, false, AppColors.softCoral),
        ],
      ),
    ).animate().fadeIn(delay: 200.ms, duration: 400.ms);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isDark ? AppColors.auroraStart.withValues(alpha: 0.2) : AppColors.lightAuroraStart.withValues(alpha: 0.15)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(challengeTitle, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary)),
                    Text(isEn ? 'Day $currentDay of $totalDays' : '$totalDays gunun $currentDay. gunu', style: GoogleFonts.inter(fontSize: 12, color: isDark ? AppColors.textSecondary : AppColors.lightTextSecondary)),
                  ],
                ),
              ),
            ],
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor: isDark ? Colors.white.withValues(alpha: 0.1) : Colors.black.withValues(alpha: 0.06),
              valueColor: AlwaysStoppedAnimation<Color>(isDark ? AppColors.auroraStart : AppColors.lightAuroraStart),
            ),
          ),
          const SizedBox(height: AppConstants.spacingMd),
          Container(
            ...
            decoration: BoxDecoration(
              color: isDark ? AppColors.auroraStart.withValues(alpha: 0.08) : AppColors.lightAuroraStart.withValues(alpha: 0.06),
              borderRadius: BorderRadius.circular(AppConstants.radiusSm),
            ),
            child: Text(isEn ? todayActionEn : todayActionTr, style: GoogleFonts.inter(fontSize: 13, height: 1.4, color: isDark ? AppColors.textSecondary : AppColors.lightTextSecondary)),
          ),
          const SizedBox(height: AppConstants.spacingMd),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              ...
              child: Text(isEn ? 'Apply Now' : 'Simdi Uygula', style: const TextStyle(fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
...
class _QuickActionFABState extends State<QuickActionFAB> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final actions = [
      _FABAction(Icons.edit_note, widget.isEn ? 'Journal' : 'Gunluk', AppColors.auroraStart, () { _toggle(); widget.onJournal(); }),
      _FABAction(Icons.nightlight_round, widget.isEn ? 'Dream' : 'Ruya', AppColors.amethyst, () { _toggle(); widget.onDream(); }),
      _FABAction(Icons.favorite, widget.isEn ? 'Gratitude' : 'Sukran', AppColors.brandPink, () { _toggle(); widget.onGratitude(); }),
      _FABAction(Icons.mood, widget.isEn ? 'Mood' : 'Ruh Hali', AppColors.celestialGold, () { _toggle(); widget.onMood(); }),
      _FABAction(Icons.air, widget.isEn ? 'Breathe' : 'Nefes', AppColors.success, () { _toggle(); widget.onBreathing(); }),
    ];
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: widget.isDark ? AppColors.surfaceDark : AppColors.lightCard,
              borderRadius: BorderRadius.circular(AppConstants.radiusSm),
              boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: widget.isDark ? 0.3 : 0.08), blurRadius: 8, offset: const Offset(0, 2))],
            ),
            child: Text(action.label, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w500, color: widget.isDark ? AppColors.textPrimary : AppColors.lightTextPrimary)),
          ),
          const SizedBox(width: AppConstants.spacingSm),
          Container(
            width: 44, height: 44,
            decoration: BoxDecoration(color: action.color.withValues(alpha: 0.15), shape: BoxShape.circle, border: Border.all(color: action.color.withValues(alpha: 0.3))),
