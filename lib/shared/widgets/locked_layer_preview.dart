            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: isDark
                    ...
                    : [Colors.white, AppColors.lightSurfaceVariant],
              ),
                      ...
                      children: [
                        ...
                        _UnlockButton(
                          text:
                              unlockCTA ??
                              L10nService.get(
                                'widgets.locked_layer_preview.unlock_default',
                                language,
                              ),
                          color: color,
    ...
    return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                L10nService.get(
                  'widgets.locked_layer_preview.pro_badge',
                  language,
                ),
                style: TextStyle(
                  fontSize: 11,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Icon(Icons.lock_outline, size: 20, color: color),
                        ...
                        children: [
                          ...
                          Text(
                            L10nService.getWithParams(
                              'widgets.locked_layer_preview.more_content',
                              language,
                              params: {'count': lockedItemCount.toString()},
                            ),
