...
class _EmotionalCycleScreenState extends ConsumerState<EmotionalCycleScreen>
  ...
  Widget _buildLockedView(BuildContext context, bool isDark, bool isEn,
      int needed, int current) {
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                // WAVE CHART
                _buildHeroWaveSection(context, isDark, isEn, chartData, displayDays)
                ...
                // SUMMARY CARDS
                Text(isEn ? 'Your Dimensions' : 'Boyutların',
                ...
                ...FocusArea.values.asMap().entries.map((entry) {
                  ...
                  return Padding(
                    ...
                    child: CycleSummaryCard(summary: summary, isDark: isDark, isEn: isEn),
                  ).animate()
                      .fadeIn(delay: (350 + entry.key * 60).ms, duration: 400.ms)
                      .slideY(begin: 0.05, end: 0, delay: (350 + entry.key * 60).ms, duration: 400.ms);
                }),
                ...
                if (analysis.insights.isNotEmpty) ...[
                  Text(isEn ? 'Cycle Insights' : 'Döngü İçgörüleri',
                      style: Theme.of(context).textTheme.titleMedium?.copyWith(
                            color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary,
                            fontWeight: FontWeight.w700))
                  ...
                  ...analysis.insights.asMap().entries.map((entry) {
                    return Padding(
                      padding: const EdgeInsets.only(bottom: AppConstants.spacingMd),
                      child: _buildInsightCard(context, isDark, isEn, entry.value),
                    ).animate().fadeIn(delay: (750 + entry.key * 60).ms, duration: 400.ms);
                  }),
                ],
                ...
                _buildShiftForecastSection(context, isDark, isEn)
                    .animate().fadeIn(delay: 850.ms, duration: 400.ms),
                const SizedBox(height: AppConstants.spacingLg),

                // PATTERN LOOPS
                _buildPatternLoopSection(context, isDark, isEn)
  ...
  Widget _buildHeroWaveSection(BuildContext context, bool isDark, bool isEn,
      Map<FocusArea, List<CycleDataPoint>> chartData, int displayDays) {
    final hasData = chartData.values.any((list) => list.isNotEmpty);
    return Container(
      padding: const EdgeInsets.all(AppConstants.spacingLg),
      decoration: BoxDecoration(
        color: isDark ? AppColors.surfaceDark.withValues(alpha: 0.8) : AppColors.lightCard,
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Text(isEn ? 'Last $displayDays Days' : 'Son $displayDays Gün',
            ...
            SizedBox(
              ...
              child: Center(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const SizedBox(height: 12),
                  Text(
                    isEn ? 'Start journaling to see your cycles' : 'Döngüleri görmek için kayıt yapmaya başla',
                    style: TextStyle(
            ...
            AnimatedBuilder(
              ...
              builder: (context, _) => SizedBox(
                ...
                child: CycleWaveChart(
                  areaData: chartData, visibleAreas: _visibleAreas,
                  isDark: isDark, displayDays: displayDays,
                  animationProgress: _waveAnimation.value,
                  onPointSelected: (info) => setState(() => _selectedPoint = info),
                ),
              ),
            ),
          ...
          if (hasData)
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(isEn ? '$displayDays days ago' : '$displayDays gün önce',
  ...
  Widget _buildSelectedPointInfo(BuildContext context, bool isDark, bool isEn) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 8),
        Text('$areaName: ${point.value.toStringAsFixed(1)}',
            style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                color: isDark ? AppColors.textPrimary : AppColors.lightTextPrimary)),
        const Spacer(),
        Text(dateStr, style: TextStyle(fontSize: 12,
            color: isDark ? AppColors.textMuted : AppColors.lightTextMuted)),
      ]),
    );
  }
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isVisible
                        ...
                        : (isDark ? AppColors.surfaceDark.withValues(alpha: 0.5) : AppColors.lightSurfaceVariant),
                    borderRadius: BorderRadius.circular(AppConstants.radiusFull),
                    border: Border.all(
                        color: isVisible ? color.withValues(alpha: 0.5) : Colors.transparent,
                        width: 1.5),
                  ),
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    AnimatedContainer(
                      ...
                      width: 10, height: 10,
                      decoration: BoxDecoration(
                        color: isVisible ? color : color.withValues(alpha: 0.25),
                        shape: BoxShape.circle,
                        boxShadow: isVisible
  ...
  Widget _buildInsightCard(BuildContext context, bool isDark, bool isEn, CycleInsight insight) {
    final color = insight.relatedArea != null
        ? (kAreaColors[insight.relatedArea!] ?? AppColors.auroraStart) : AppColors.auroraStart;
    ...
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(
          child: Text(isEn ? insight.messageEn : insight.messageTr,
  ...
  IconData _insightIcon(CycleInsight insight) {
    ...
    if (msg.contains('move together') || msg.contains('tend to be')) return Icons.link;
          ...
          if (!isPremium) ...[
            ...
            Container(
              ...
              child: const Text('PRO',
                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.starGold)),
            ),
          ],
        ]),
        const SizedBox(height: AppConstants.spacingMd),
  ...
  Widget _buildPatternLoopSection(BuildContext context, bool isDark, bool isEn) {
    final loopAnalysisAsync = ref.watch(patternLoopAnalysisProvider);
    return loopAnalysisAsync.when(
      loading: () => const SizedBox.shrink(),
      error: (_, _) => const SizedBox.shrink(),
      data: (loopAnalysis) => PatternLoopAnalyzer(analysis: loopAnalysis, isDark: isDark, isEn: isEn),
    );
  }
  ...
  Widget _buildShareButton(BuildContext context, bool isDark, bool isEn) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(AppConstants.radiusLg),
        gradient: const LinearGradient(colors: [AppColors.auroraStart, AppColors.auroraEnd]),
        boxShadow: [
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(isEn ? 'Share My Inner Cycles' : 'İç Döngülerimi Paylaş',
  ...
  Widget _buildPremiumGate(BuildContext context, bool isDark, bool isEn, int totalEntries) {
    return Container(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: AppConstants.spacingMd),
        Text(isEn ? 'Unlock Full 30-Day View' : 'Tam 30 Günlük Görünümü Aç',
            style: Theme.of(context).textTheme.titleMedium?.copyWith(
                  color: AppColors.starGold, fontWeight: FontWeight.w600)),
        const SizedBox(height: AppConstants.spacingSm),
        Text(
          isEn
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            onPressed: () => showContextualPaywall(context, ref, paywallContext: PaywallContext.patterns),
            ...
            child: Text(isEn ? 'Go Premium' : 'Premium\'a Geç',
                style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
          ),
        ),
      ]),
