...
class _EmotionalCycleScreenState extends ConsumerState<EmotionalCycleScreen>
                ...
                if (analysis.overallPhase != null) ...[
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Text(
                        analysis.overallPhase!.description(language),
                        textAlign: TextAlign.center,
                        style: AppTypography.decorativeScript(
                          fontSize: 13,
                          color: isDark
  ...
  Widget _buildSelectedPointInfo(BuildContext context, bool isDark, bool language) {
  ...
  Widget _buildLegend(BuildContext context, bool isDark, bool language) {
    ...
    return PremiumCard(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              insight.localizedMessage(language),
              style: AppTypography.decorativeScript(
                fontSize: 14,
                color: isDark
                    ? AppColors.textPrimary
