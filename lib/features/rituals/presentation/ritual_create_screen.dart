...
class _RitualCreateScreenState extends ConsumerState<RitualCreateScreen> {
  ...
  void _updateDefaultName() {
    ...
    _nameController.text = _selectedTime.localizedName(language);
  }
                        ...
                        Wrap(
                          ...
                          children: RitualTime.values.map((time) {
                            ...
                            return ConstrainedBox(
                              ...
                              child: Semantics(
                                label: time.localizedName(language),
                                button: true,
                                selected: isSelected,
                                child: GestureDetector(
                                  onTap: () {
  ...
  Widget _buildHabitSuggestions(bool isDark, bool language) {
  ...
  String _getPlaceholder(int index, bool language) {
