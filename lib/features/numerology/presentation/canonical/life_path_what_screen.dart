          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection(
                  isDark,
                  L10nService.get('canonical.short_answer', language),
                  color,
                  [
                ...
                _buildSection(
                  isDark,
                  L10nService.get(
                    'canonical.life_path.how_calculated',
                    language,
                  ),
                  color,
                  [
                ...
                _buildSection(
                  isDark,
                  L10nService.get('canonical.life_path.what_tells', language),
                  color,
                  [
                ...
                _buildSection(
                  isDark,
                  L10nService.get('canonical.important_note', language),
                  color,
                  [
                ...
                _buildSuggestion(
                  ...
                  language,
                  '🔢',
                  L10nService.get('canonical.life_path.suggestion', language),
                  Routes.numerology,
                ),
                ...
                Center(
                  child: Text(
                    L10nService.get('numerology.brand_footer', language),
                    style: TextStyle(
                      fontSize: 12,
