...
class _GenericQuizScreenState extends ConsumerState<GenericQuizScreen> {
      ...
      body: CosmicBackground(
        child: SafeArea(
          child: _showResult && _result != null
              ? _buildResultView(context, definition, isDark, language)
              : _buildQuizView(context, definition, isDark, language),
        ),
      ),
    );
  }
  ...
  Widget _buildQuizView(
    ...
    return Column(
      children: [
        _buildQuizAppBar(context, definition, isDark, language),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              definition.localizedTitle(language),
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              ...List.generate(question.options.length, (optionIndex) {
                ...
                final optionText = option.localizedText(language);
              ...
              delegate: SliverChildListDelegate([
                ...
                if (winningDim.strengthsEn.isNotEmpty) ...[
                  _buildListSection(
                    ...
                    items: winningDim.localizedStrengths(language),
                ...
                if (winningDim.growthAreasEn.isNotEmpty) ...[
                  _buildListSection(
                    ...
                    items: winningDim.localizedGrowthAreas(language),
                ...
                const SizedBox(height: AppConstants.spacingMd),
                _buildBackToHubButton(context, isDark, language),
    ...
    return Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                dim.localizedDescription(language),
                style: AppTypography.decorativeScript(
                  fontSize: 15,
                  color: isDark
  ...
  Widget _buildBackToHubButton(BuildContext context, bool isDark, bool language) {
    return SizedBox(
