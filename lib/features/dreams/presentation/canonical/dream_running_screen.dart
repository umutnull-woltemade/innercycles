...
/// Rüyada Kaçmak Ne Anlama Gelir? - AI-First Canonical Sayfa
class DreamRunningScreen extends ConsumerWidget {
  const DreamRunningScreen({super.key});
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? [const Color(0xFF0D0D1A), const Color(0xFF1A1018)]
                : [const Color(0xFFFFF8F5), const Color(0xFFFFF0EB)],
          ),
        ),
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  L10nService.get(
                    'dreams.canonical.running_question',
                    language,
                  ),
                  style: TextStyle(
                    fontSize: 28,
                ...
                _buildSection(
                  isDark,
                  L10nService.get(
                    'dreams.canonical.running.from_title',
                    language,
                  ),
                  color,
                  [
