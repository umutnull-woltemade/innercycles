            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection(isDark, L10nService.get('dreams.canonical.sections.short_answer', language), color, [
                  L10nService.get('dreams.canonical.past.short_answer_1', language),
                  L10nService.get('dreams.canonical.past.short_answer_2', language),
                  L10nService.get('dreams.canonical.past.short_answer_3', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.past.who_title', language), color, [
                  L10nService.get('dreams.canonical.past.who_1', language),
                  L10nService.get('dreams.canonical.past.who_2', language),
                  L10nService.get('dreams.canonical.past.who_3', language),
                  L10nService.get('dreams.canonical.past.who_4', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.sections.what_it_means', language), color, [
                  L10nService.get('dreams.canonical.past.meaning_1', language),
                  L10nService.get('dreams.canonical.past.meaning_2', language),
                  L10nService.get('dreams.canonical.past.meaning_3', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.sections.if_recurring', language), color, [
                  L10nService.get('dreams.canonical.past.recurring_1', language),
                  L10nService.get('dreams.canonical.past.recurring_2', language),
                  L10nService.get('dreams.canonical.past.recurring_3', language),
                ]),
                const SizedBox(height: 32),
