      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? [const Color(0xFF0D0D1A), const Color(0xFF0A1A15)]
                : [const Color(0xFFF5FFF8), const Color(0xFFE8FFF0)],
          ),
        ),
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                IconButton(onPressed: () => context.pop(), tooltip: L10nService.get('common.back', language), icon: Icon(Icons.arrow_back_ios, color: isDark ? Colors.white70 : AppColors.textDark)),
                const SizedBox(height: 24),
                Text(L10nService.get('dreams.canonical.lost_question', language), style: TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: isDark ? Colors.white : AppColors.textDark, height: 1.2)).animate().fadeIn(duration: 400.ms),
                ...
                _buildSection(isDark, L10nService.get('dreams.canonical.sections.short_answer', language), color, [
                  L10nService.get('dreams.canonical.lost.short_answer_1', language),
                  L10nService.get('dreams.canonical.lost.short_answer_2', language),
                  L10nService.get('dreams.canonical.lost.short_answer_3', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.lost.where_title', language), color, [
                  L10nService.get('dreams.canonical.lost.where_1', language),
                  L10nService.get('dreams.canonical.lost.where_2', language),
                  L10nService.get('dreams.canonical.lost.where_3', language),
                  L10nService.get('dreams.canonical.lost.where_4', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.sections.what_it_means', language), color, [
                  L10nService.get('dreams.canonical.lost.meaning_1', language),
                  L10nService.get('dreams.canonical.lost.meaning_2', language),
                  L10nService.get('dreams.canonical.lost.meaning_3', language),
                ]),
                const SizedBox(height: 28),
                _buildSection(isDark, L10nService.get('dreams.canonical.lost.find_title', language), color, [
                  L10nService.get('dreams.canonical.lost.find_1', language),
                  L10nService.get('dreams.canonical.lost.find_2', language),
                  L10nService.get('dreams.canonical.lost.find_3', language),
                ]),
                const SizedBox(height: 32),
