...
class DreamSymbolsDatabase {
  static const List<DreamSymbolData> allSymbols = [
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'Hedeflere ulaşma arzusu ve özlem',
        'Aşılması gereken engeller',
        'Ruhsal yükseliş ve olgunlaşma',
        'Yüksekten bakış ve perspektif kazanma',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Zirveye ulaşma isteği - hedefin net ve güçlü',
        EmotionalTone.korku: 'Dağın yüksekliği korkutuyor - başarısızlık kaygısı',
        EmotionalTone.huzur: 'Zirvede sükunet - dünyaya yukarıdan bakış',
        EmotionalTone.merak: 'Öte yanda ne var? Keşfedilmemiş zirveler çağırıyor',
      },
      archetypes: ['Kahraman', 'Bilge', 'Ruh'],
      relatedSymbols: ['forest', 'road', 'cave', 'storm'],
      shadowAspect: 'Ulaşılamaz hedefler, kibir, yalnızlık zirvesi',
      lightAspect: 'Azim, ruhsal yükseliş, geniş perspektif',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Bir dönemden diğerine geçiş',
        'Bağlantı kurma ve köprü olma',
        'Karşıya geçme ve ilerleme',
        'Eskiyi geride bırakma',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Köprü sallanıyor - geçiş sürecinde kaybolma korkusu',
        EmotionalTone.huzur: 'Güvenli geçiş - iki dünya arasında denge',
        EmotionalTone.ozlem: 'Geçilmemiş köprü - ertelenen değişim özlemi',
        EmotionalTone.heyecan: 'Öte taraf çekiyor - dönüşüm kapıda',
      },
      archetypes: ['Arabulucu', 'Yolculuk', 'Geçiş'],
      relatedSymbols: ['river', 'road', 'door', 'water'],
      shadowAspect: 'Yarım kalmış geçişler, köprüyü yakmak, geri dönememek',
      lightAspect: 'Bağlantı kurma, ilerleme cesareti, dönüşüm',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Ölümlülük ve zamanın sınırlılığı',
        'Aciliyet ve baskı hissi',
        'Hayatın evreleri ve geçicilik',
        'Kaçırılan fırsatlar ve pişmanlık',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Zaman daralıyor - yetişemiyorum kaygısı',
        EmotionalTone.sucluluk: 'Zamanı iyi kullanmadım - pişmanlık',
        EmotionalTone.donukluk: 'Saat durmuş - hayat askıya alınmış',
        EmotionalTone.heyecan: 'Doğru an geldi - harekete geçme zamanı',
      },
      archetypes: ['Zamansız', 'Yargıç', 'Geçicilik'],
      relatedSymbols: ['death', 'exam', 'train', 'road'],
      shadowAspect: 'Zaman baskısı, pişmanlık, kaçan fırsatlar',
      lightAspect: 'Anın değeri, bilinçli yaşam, doğru zamanlama',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Toplumsal persona ve rol oynama',
        'Gizlenen gerçek benlik',
        'Sosyal beklentilere uyum',
        'Aldatma ve gizem',
      ],
      emotionVariants: {
        EmotionalTone.sucluluk: 'Gerçek ben bu değil - sahtelik hissi',
        EmotionalTone.korku: 'Maske düşerse ne olur? Teşhir korkusu',
        EmotionalTone.merak: 'Maskenin arkasında kim var? İç kimlik sorgusu',
        EmotionalTone.donukluk: 'Maskeyle yaşamak artık yorucu - uyuşukluk',
      },
      archetypes: ['Persona', 'Gölge', 'Oyuncu'],
      relatedSymbols: ['mirror', 'stranger', 'shadow', 'naked'],
      shadowAspect: 'Sahtelik, kimlik kaybı, gerçeği gizleme',
      lightAspect: 'Sosyal zeka, rol esnekliği, koruyucu sınır',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'İçsel büyüme ve öz-gelişim',
        'Bilinçle şekillendirilmiş iç dünya',
        'Verimlilik ve yaratıcı potansiyel',
        'Cennet ve huzur yeri özlemi',
      ],
      emotionVariants: {
        EmotionalTone.huzur: 'Özenle yetiştirilmiş iç dünya - huzur ve denge',
        EmotionalTone.ozlem: 'Kayıp cennet - masumiyete dönüş özlemi',
        EmotionalTone.heyecan: 'Ektiğim tohumlar filizleniyor - büyüme heyecanı',
        EmotionalTone.sucluluk: 'Bahçeyi ihmal ettim - öz-bakımı erteleme',
      },
      archetypes: ['Yaratıcı', 'Bahçıvan', 'Cennet'],
      relatedSymbols: ['tree', 'flower', 'water', 'forest'],
      shadowAspect: 'İhmal, büyümeyen tohumlar, kendi kendini sabote etme',
      lightAspect: 'Öz-gelişim, sabır, bilinçli yetiştirme',
    ),
    ...
    DreamSymbolData(
      ...
      universalMeanings: [
        ...
        'Yüksek hedefler ve hırs',
        'Ego ve kibir yapıları',
        'Yüksekten perspektif ve mesafe',
      ],
      emotionVariants: {
        EmotionalTone.donukluk: 'Kulede mahsur - duygusal izolasyon',
        EmotionalTone.korku: 'Kule yıkılıyor - ego çöküşü',
        EmotionalTone.heyecan: 'En yükseğe çıkacağım - hırs ve azim',
        EmotionalTone.ozlem: 'Aşağıdaki hayata özlem - bağlantısızlık',
      },
      archetypes: ['Kral', 'Kahraman', 'Ego'],
      relatedSymbols: ['mountain', 'house', 'prison', 'attic'],
      shadowAspect: 'Kibir, izolasyon, çöken ego yapıları',
      lightAspect: 'Büyük vizyon, liderlik, perspektif gücü',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'Karmaşa ve yön kaybı',
        'Hayatın zor seçimleri',
        'İçsel yolculuk ve keşif',
        'Tuzağa düşme ve çıkış arayışı',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Çıkış yok - tuzakta hissetme',
        EmotionalTone.merak: 'Her köşe yeni bir seçenek - keşif zevki',
        EmotionalTone.donukluk: 'Döngüde sıkışmış - aynı hataları tekrar etme',
        EmotionalTone.heyecan: 'Merkeze ulaşacağım - çözüm yakın',
      },
      archetypes: ['Kahraman', 'Arayan', 'Dönüşüm'],
      relatedSymbols: ['lost', 'forest', 'basement', 'road'],
      shadowAspect: 'Bilinçsiz döngüler, çıkışsızlık, kendini sabote',
      lightAspect: 'Bilinçli yolculuk, öz-keşif, azimle çözüm bulma',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.dogaOlayi,
      universalMeanings: [
        'Hayatın doğal akışı ve sürekliliği',
        'Zamanın ilerleyişi ve geçicilik',
        'Duygusal akımlar ve güçlü hisler',
        'Bir yolculuk ve varış yeri',
      ],
      emotionVariants: {
        EmotionalTone.huzur: 'Akışla gitmek - hayata teslim olma huzuru',
        EmotionalTone.korku: 'Akıntı beni sürüklüyor - kontrol kaybı',
        EmotionalTone.ozlem: 'Nehrin karşı kıyısında ne var? Erişilemeyen hedef',
        EmotionalTone.merak: 'Nereye akıyor? Hayatın yönünü keşfetme',
      },
      archetypes: ['Yolcu', 'Zaman', 'Bilinçdışı'],
      relatedSymbols: ['water', 'ocean', 'bridge', 'boat'],
      shadowAspect: 'Kontrol edilemez duygular, sürüklenme, yön kaybı',
      lightAspect: 'Hayatın ritmini kabullenme, akışa güvenme',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Hayatın rotası ve yönü',
        'Kolektif yolculuk ve aidiyet',
        'Kaçırılan fırsatlar ve son dakika',
        'Kader ve önceden belirlenmiş yol',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Tren gidiyor - fırsat kaçıyor',
        EmotionalTone.heyecan: 'Doğru trene bindim - yola çıkıyorum',
        EmotionalTone.donukluk: 'Aynı raylar, aynı durak - rutine hapsolma',
        EmotionalTone.ozlem: 'Trende değilim - geride kalmış hissi',
      },
      archetypes: ['Yolcu', 'Kader', 'Topluluk'],
      relatedSymbols: ['road', 'driving', 'clock', 'lost'],
      shadowAspect: 'Kaçırılan fırsatlar, kader tuzağı, özgürlüksüzlük',
      lightAspect: 'Hedefe odaklı yolculuk, kaderi kucaklama',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'Yalnızlık ve toplumdan uzaklaşma',
        'Öz-yeterlililik ve bağımsızlık',
        'Sığınak ve güvenli alan',
        'Yalıtılmışlık ve bağlantısızlık',
      ],
      emotionVariants: {
        EmotionalTone.huzur: 'Kendi adaş - dış dünyadan huzurlu kaçış',
        EmotionalTone.donukluk: 'Mahsur ada - yardım ulaşmıyor, izolasyon',
        EmotionalTone.ozlem: 'Adadan karaya özlem - bağlantı ihtiyacı',
        EmotionalTone.heyecan: 'Keşfedilmemiş ada - özgürlük ve macera',
      },
      archetypes: ['Münzevi', 'Birey', 'Sığınak'],
      relatedSymbols: ['ocean', 'desert', 'house', 'lost'],
      shadowAspect: 'Zorla izolasyon, bağlantısızlık, yardım edememek',
      lightAspect: 'Özgürlük, özerklik, içsel kaynakları keşfetme',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Gelişim ve ilerleme basamakları',
        'Ruhsal yükseliş ve olgunlaşma',
        'Hırs ve yukarı tırmanma',
        'Gerileme ve aşağı inme',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Yukarı çıkıyorum - gelişim ve yükseliş',
        EmotionalTone.korku: 'Merdiven sonsuz ya da çöküyor - ilerleme kaygısı',
        EmotionalTone.donukluk: 'Aynı basamakta duruyorum - ilerleme yok',
        EmotionalTone.sucluluk: 'Aşağı indim - gerileme hissi',
      },
      archetypes: ['Kahraman', 'Ruh', 'Dönüşüm'],
      relatedSymbols: ['mountain', 'attic', 'basement', 'flying'],
      shadowAspect: 'Gerileme, ilerleme korkusu, tırmanamamak',
      lightAspect: 'Adım adım büyüme, bilinçli ilerleme, yükseliş',
    ),
    ...
    DreamSymbolData(
      ...
      universalMeanings: [
        ...
        'Rahme ve yeniden doğuş',
        'Gizli bilgi ve içsel sırlar',
        'İçe çekilme ve yalnız kalma',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Karanlık mağara - bilinçdışı korkular yüzeye çıkıyor',
        EmotionalTone.merak: 'Mağaranın derinliği çekiyor - içsel keşif',
        EmotionalTone.huzur: 'Mağarada sığınak buldum - kendi içime çekilme',
        EmotionalTone.donukluk: 'Mağaradan çıkmıyorum - dışa kapanma',
      },
      archetypes: ['Bilinçdışı', 'Anne', 'Bilge'],
      relatedSymbols: ['basement', 'forest', 'shadow', 'dark'],
      shadowAspect: 'İçe kapanma, bilinçdışı korkular, izolasyon',
      lightAspect: 'İçsel bilgelik, yeniden doğuş, derin öz-keşif',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'İlerlemeyi engelleyen bariyerler',
        'Kendini koruma ve sınır koyma',
        'Kısıtlama ve hapsolma hissi',
        'Duygusal ya da zihinsel sınırlar',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Duvar aşılamaz - ilerleme bloke edilmiş',
        EmotionalTone.ofke: 'Bu duvarı yıkacağım - engellerle yüzleşme',
        EmotionalTone.huzur: 'Duvar koruyor - sağlıklı sınır hissi',
        EmotionalTone.donukluk: 'Duvarın arkasında tıkandım - hareketsizlik',
      },
      archetypes: ['Koruyucu', 'Engel', 'Sınır'],
      relatedSymbols: ['prison', 'door', 'house', 'maze'],
      shadowAspect: 'Kendini kapatma, duygusal barikat, ilerlemeyi reddetme',
      lightAspect: 'Sağlıklı sınırlar, öz-koruma, net çizgiler',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.soyut,
      universalMeanings: [
        'Hayat enerjisi ve canlılık',
        'Fedakarlık ve bedel ödeme',
        'Aile bağları ve soy',
        'Yara ve iyileşme süreci',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Kan görüyorum - kayıp ya da tehlike sinyali',
        EmotionalTone.sucluluk: 'Birinin kanı bende - fedakarlık yükü',
        EmotionalTone.ofke: 'Kan kaynaması - bastırılamaz öfke',
        EmotionalTone.huzur: 'Kan hayat demek - kendi canlılığına şükran',
      },
      archetypes: ['Fedakar', 'Hayat', 'Soy'],
      relatedSymbols: ['death', 'war', 'fire', 'mother'],
      shadowAspect: 'Şiddet, kayıp, kanayan yaralar, soy yükü',
      lightAspect: 'Hayat gücü, fedakarlığın onuru, aile bağı',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Otorite ve güç konumu',
        'Başarı ve tanınma arzusu',
        'Ego ve büyüklük kurgusu',
        'Ruhsal ustalık ve aydınlanma',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Taç bana yakışıyor - hakkaniyetli güç ve başarı',
        EmotionalTone.sucluluk: 'Bu tacı hak etmedim - sahtekarlık sendromu',
        EmotionalTone.korku: 'Taç düşerse ne olur? - statü kaybı korkusu',
        EmotionalTone.donukluk: 'Taç ağır geliyor - sorumluluk yorgunluğu',
      },
      archetypes: ['Kral/Kraliçe', 'Ego', 'Bilge'],
      relatedSymbols: ['tower', 'father', 'gold', 'death'],
      shadowAspect: 'Kibir, hak etmediğini düşünme, güç sarhoşluğu',
      lightAspect: 'Liyakatli liderlik, ruhsal olgunluk, öz-saygı',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'Hayat yolculuğu ve seçimler',
        'Karar anları ve ayrım noktaları',
        'Yolculuk süreci ve hedef',
        'Kader ve bilinçli yön belirleme',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Açık yol önümde - özgürlük ve ilerleme',
        EmotionalTone.korku: 'Yol bitiyor ya da karanlık - belirsizlik kaygısı',
        EmotionalTone.ozlem: 'Yolun sonunu merak ediyorum - anlam arayışı',
        EmotionalTone.donukluk: 'Yolda durdum - hareketsizlik ve tıkanma',
      },
      archetypes: ['Yolcu', 'Kahraman', 'Arayan'],
      relatedSymbols: ['driving', 'train', 'bridge', 'lost'],
      shadowAspect: 'Yoldan sapma, kaybolma, amacını yitirme',
      lightAspect: 'Bilinçli seçimler, hayatına yön verme, ilerleme',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Dışarıya açılan perspektif ve bakış açısı',
        'Kapı aralığındaki fırsatlar',
        'Öz-farkındalık ve gözlem',
        'Ruhun dış dünyaya açılan gözü',
      ],
      emotionVariants: {
        EmotionalTone.ozlem: 'Pencereden bakıyorum ama çıkamıyorum - özlem',
        EmotionalTone.huzur: 'Pencereden ışık giriyor - umut ve açıklık',
        EmotionalTone.merak: 'Pencerede ne görünüyor? - keşfetme isteği',
        EmotionalTone.donukluk: 'Pencere kapalı ya da buzlu - içe kapanma',
      },
      archetypes: ['Gözlemci', 'Arayan', 'Bilinç'],
      relatedSymbols: ['door', 'house', 'mirror', 'room'],
      shadowAspect: 'Dışarıya hasret ama hareketsiz, fırsatları kaçırma',
      lightAspect: 'Farkındalık, perspektif genişliği, umut',
    ),
    ...
    DreamSymbolData(
      ...
      universalMeanings: [
        ...
        'Köklere bağlılık ve aile',
        'Hayat döngüsü ve mevsimler',
        'Dayanıklılık ve süreklilik',
      ],
      emotionVariants: {
        EmotionalTone.huzur: 'Köklü ağaç - içsel sağlamlık ve denge',
        EmotionalTone.ozlem: 'Ağacın altında - köklere ve geçmişe özlem',
        EmotionalTone.korku: 'Ağaç devrildi - temel sarsılıyor',
        EmotionalTone.merak: 'Ağacın içinde ne var? - gizemli içsel dünya',
      },
      archetypes: ['Öz-Benlik', 'Soy', 'Dünya Ağacı'],
      relatedSymbols: ['forest', 'garden', 'root', 'branch'],
      shadowAspect: 'Köksüzlük, devrilme, aile baskısı',
      lightAspect: 'Köklü büyüme, dayanıklılık, nesiller boyu süreklilik',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.insan,
      universalMeanings: [
        'Yeni başlangıçlar ve taze sayfa',
        'Kırılganlık ve bakıma muhtaçlık',
        'Masumiyet ve saf potansiyel',
        'İçsel çocuk ve doğal hal',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Yeni doğan bir şey - taze başlangıç enerjisi',
        EmotionalTone.korku: 'Bebeğe bakamazsam - sorumluluk korkusu',
        EmotionalTone.ozlem: 'Kayıp masumiyet - çocukluğa dönüş arzusu',
        EmotionalTone.sucluluk: 'İçimdeki çocuğu ihmal ettim - öz-bakım eksikliği',
      },
      archetypes: ['İçsel Çocuk', 'Yeni Başlangıç', 'Masumiyet'],
      relatedSymbols: ['child', 'pregnancy', 'mother', 'birth'],
      shadowAspect: 'Kırılganlıktan kaçış, sorumluluğu reddetme',
      lightAspect: 'Yenilenme, masumiyet, saf yaratıcı potansiyel',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.soyut,
      universalMeanings: [
        'Bastırılmış ve kabul edilmemiş yönler',
        'Karanlık taraf ve bilinçdışı güçler',
        'Entegrasyon ve bütünleşme ihtiyacı',
        'Yansıtma ve projeksiyon mekanizması',
      ],
      emotionVariants: {
        EmotionalTone.korku: 'Gölge kovalıyor - bastırılanlar yüzleşme istiyor',
        EmotionalTone.merak: 'Gölgemde ne var? - öz-keşif cesareti',
        EmotionalTone.donukluk: 'Gölgeyle dans - bilinçdışı farkındalık',
        EmotionalTone.sucluluk: 'Gölgemden utanıyorum - reddedilen parçalar',
      },
      archetypes: ['Gölge', 'Bilinçdışı', 'Entegrasyon'],
      relatedSymbols: ['mask', 'mirror', 'dark', 'stranger'],
      shadowAspect: 'İnkar, projeksiyon, reddedilen yönlerle savaş',
      lightAspect: 'Entegrasyon, bütünleşme, gölgeyi kucaklama',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.soyut,
      universalMeanings: [
        'Yüksek benlik ve ilahi rehberlik',
        'Koruma ve kutsal himaye',
        'Manevi mesaj ve uyarı',
        'Umut ve lütuf deneyimi',
      ],
      emotionVariants: {
        EmotionalTone.huzur: 'Melek koruyor - güvende hissetme, teslim olma',
        EmotionalTone.heyecan: 'Manevi mesaj geliyor - içsel açılım',
        EmotionalTone.ozlem: 'Kayıp meleğe özlem - ilahi bağlantı arayışı',
        EmotionalTone.merak: 'Melek ne söylüyor? - yüksek benliğe kulak verme',
      },
      archetypes: ['Yüksek Benlik', 'Rehber', 'Ruh'],
      relatedSymbols: ['light', 'deceased', 'flying', 'heaven'],
      shadowAspect: 'Sahte rehberlik, pasif teslimiyet, sorumluluktan kaçış',
      lightAspect: 'Manevi bağ, içsel yönlenme, koruyucu güç',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.nesne,
      universalMeanings: [
        'Duygusal denizde yolculuk',
        'Belirsizliğe açılma ve geçiş',
        'Keşif ruhu ve macera',
        'Yalnız ya da birlikte yolculuk',
      ],
      emotionVariants: {
        EmotionalTone.heyecan: 'Yelkenler açık - duygusal cesaret ve keşif',
        EmotionalTone.korku: 'Tekne batıyor - duygusal taşkın korkusu',
        EmotionalTone.huzur: 'Sakin sularda süzülüyorum - iç denge',
        EmotionalTone.donukluk: 'Tekne bağlı, hareket yok - hareketsizlik',
      },
      archetypes: ['Gezgin', 'Yolcu', 'Arayan'],
      relatedSymbols: ['ocean', 'river', 'water', 'bridge'],
      shadowAspect: 'Duygusal fırtınada kaybolma, demir atmak istememek',
      lightAspect: 'Cesaretli yolculuk, duygusal akışa açılma',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'İçsel boşluk ve anlamsızlık',
        'Dayanma gücü ve sabır testi',
        'Ruhsal arınma süreci',
        'Sınavdan geçme ve olgunlaşma',
      ],
      emotionVariants: {
        EmotionalTone.donukluk: 'Çölde yürüyorum - duygusal kuruluk, uyuşukluk',
        EmotionalTone.korku: 'Çölde kayboldum - destek yok, yapayalnız',
        EmotionalTone.huzur: 'Çölün sessizliği - arınmış, saf ve yalın an',
        EmotionalTone.heyecan: 'Çölü aşacağım - sınırları zorlama azmi',
      },
      archetypes: ['Münzevi', 'Sınav', 'Arınma'],
      relatedSymbols: ['island', 'lost', 'storm', 'road'],
      shadowAspect: 'Tükeniş, boşluk, yardımsız yalnızlık',
      lightAspect: 'Ruhsal arınma, sadelik, iç kaynaklarını keşfetme',
    ),
    ...
    DreamSymbolData(
      ...
      universalMeanings: [
        'Hakikat ve netlik',
        'Güç ve otorite',
        'Kararlılık ve keskin seçim',
        'Çatışma ve mücadele',
      ],
      emotionVariants: {
        EmotionalTone.ofke: 'Kılıç sallanıyor - yıkıcı öfke, saldırganlık',
        EmotionalTone.heyecan: 'Kılıcı kuşandım - güç ve kararlılık',
        EmotionalTone.korku: 'Kılıç bana yönelmiş - tehdit altındayım',
        EmotionalTone.huzur: 'Kılıç kınında - güç var ama savaşa gerek yok',
      },
      archetypes: ['Savaşçı', 'Kahraman', 'Adalet'],
      relatedSymbols: ['war', 'fire', 'shield', 'crown'],
      shadowAspect: 'Saldırganlık, tahakküm, hakikati silah olarak kullanma',
      lightAspect: 'Netlik, doğruyu savunma, cesur kararlılık',
    ),
    ...
    DreamSymbolData(
      ...
      category: SymbolCategory.mekan,
      universalMeanings: [
        'Mahsur hissetme ve özgürlük kaybı',
        'Suçluluk duygusu ve ceza beklentisi',
        'Kendi yarattığın kısıtlamalar',
        'Sınırlar ve özgürleşme ihtiyacı',
      ],
      emotionVariants: {
        EmotionalTone.sucluluk: 'Bu hapishaneyi hak ettim - öz-cezalandırma',
        EmotionalTone.ofke: 'Buradan çıkacağım - başkaldırı ve isyan',
        EmotionalTone.donukluk: 'Alıştım hapishaneye - öğrenilmiş çaresizlik',
        EmotionalTone.korku: 'Çıkış yolu yok - çaresizlik ve panik',
      },
      archetypes: ['Gölge', 'Kurban', 'Dönüşüm'],
      relatedSymbols: ['wall', 'cage', 'key', 'door'],
      shadowAspect: 'Öz-sabotaj, suçlulukla kendini hapsettirme, çaresizlik',
      lightAspect: 'Özgürleşme cesareti, sınırları tanıma, içsel kurtuluş',
    ),
  ];
