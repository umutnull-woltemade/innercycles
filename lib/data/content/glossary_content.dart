...
class GlossaryContent {
  ...
  static final List<GlossaryEntry> _aspectTerms = [
    ...
    GlossaryEntry(
      ...
      deepExplanation:
          'Nadir bulunan, güçlü karmik yapılandırma. "Tanrı\'nın parmağı" anlamına gelir. Güçlü bir yaşam amacı hissi veren tema. Tepe noktasındaki gezegen kilit rol oynar.',
      category: GlossaryCategory.aspects,
