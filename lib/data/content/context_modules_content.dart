...
const List<ContextModule> allContextModules = [
  ...
  ContextModule(
    ...
    summaryEn:
        'Most people have recurring emotional patterns across the week that they have never noticed.',
    summaryTr:
  ...
  ContextModule(
    ...
    bodyEn:
        'Nature runs on cycles: seasons, tides, circadian rhythms, sleep stages. Human emotional life follows the same principle. People tend to experience periods of high energy, creativity, and social engagement — naturally followed by periods of solitude, rest, and inner processing. The problem is that modern culture treats the "up" phase as normal and the "down" phase as a problem to fix. Both are essential. A farmer does not panic when winter comes — they know spring follows. Your emotional cycles work the same way. Tracking them over time helps you stop fighting the current phase and start working with it.',
    bodyTr:
