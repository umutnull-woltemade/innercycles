...
const List<GranularEmotion> allGranularEmotions = [
  ...
  GranularEmotion(
    ...
    nameTr: 'Memnun',
    descriptionEn:
        'A quiet satisfaction with the present moment, without needing anything to change.',
    descriptionTr:
        'Hiçbir şeyin değişmesine gerek duymadan şu anla sessiz bir memnuniyet.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Eğlenceli',
    descriptionEn:
        'A light, carefree energy that wants to laugh, create, or be spontaneous.',
    descriptionTr:
        'Gülmek, yaratmak veya spontan olmak isteyen hafif, kaygısız bir enerji.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Umutlu',
    descriptionEn:
        'A gentle belief that things can improve, even when the current situation is difficult.',
    descriptionTr:
        'Mevcut durum zor olsa bile işlerin iyileşebileceğine dair yumuşak bir inanç.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Melankolik',
    descriptionEn:
        'A gentle, bittersweet sadness — not sharp pain, but a wistful awareness of loss or impermanence.',
    descriptionTr:
        'Yumuşak, tatlı-acı bir üzüntü — keskin acı değil, kayıp veya geçiciliğin hüzünlü farkındalığı.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Yalnız',
    descriptionEn:
        'A longing for connection that feels out of reach, even when others are physically present.',
    descriptionTr:
        'Başkaları fiziksel olarak orada olsa bile ulaşılamaz hissedilen bir bağlantı özlemi.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Nostaljik',
    descriptionEn:
        'A wistful longing for a time, place, or feeling from the past.',
    descriptionTr:
        'Geçmişten bir zaman, yer veya duygu için hüzünlü bir özlem.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Boş',
    descriptionEn:
        'An absence of feeling — not peace, but a flatness where emotions usually live.',
    descriptionTr:
        'Duygu yokluğu — huzur değil, duyguların genellikle yaşadığı yerde bir düzlük.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Sinirli',
    descriptionEn:
        'A mild annoyance at something that is not going as expected or desired.',
    descriptionTr:
        'Beklendiği veya istendiği gibi gitmeyen bir şeye karşı hafif bir rahatsızlık.',
  ...
  GranularEmotion(
    ...
    descriptionEn:
        'The tension of wanting to move forward but being blocked by obstacles.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Kırgın',
    descriptionEn:
        'A lingering bitterness about a perceived unfairness or unresolved hurt.',
    descriptionTr:
        'Algılanan bir adaletsizlik veya çözülmemiş bir acı hakkında süregelen bir acılık.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Bunalmış',
    descriptionEn:
        'Too much input, too many demands — a system overload that often disguises itself as anger.',
    descriptionTr:
        'Çok fazla girdi, çok fazla talep — kendini çoğu zaman öfke olarak gizleyen bir sistem aşırı yüklenmesi.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Kaygılı',
    descriptionEn:
        'A future-oriented worry about something that may or may not happen.',
    descriptionTr:
        'Olabilecek veya olmayabilecek bir şey hakkında geleceğe yönelik bir endişe.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Savunmasız',
    descriptionEn:
        'A sense of being exposed or unprotected, often accompanied by tenderness.',
    descriptionTr:
        'Açık veya korumasız olma hissi, genellikle hassasiyetle birlikte.',
    bodySensationEn:
        'Open chest, urge to cover or hide, heightened sensitivity',
    bodySensationTr:
        'Açık göğüs, örtünme veya saklanma dürtüsü, artmış hassasiyet',
    emoji: '🥺',
  ),
  GranularEmotion(
    id: 'fear_uncertain',
    ...
    nameTr: 'Belirsiz',
    descriptionEn:
        'The discomfort of not knowing what comes next or which choice to make.',
    descriptionTr:
        'Bundan sonra ne olacağını veya hangi seçimi yapacağını bilmemenin rahatsızlığı.',
  ...
  GranularEmotion(
    ...
    descriptionEn:
        'The mental fog of not being able to make sense of what is happening.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Huşu İçinde',
    descriptionEn:
        'A profound sense of wonder in the presence of something vast or deeply meaningful.',
    descriptionTr:
        'Büyük veya derinden anlamlı bir şeyin varlığında derin bir hayranlık duygusu.',
    bodySensationEn: 'Stillness, tears of wonder, feeling small but connected',
    bodySensationTr:
        'Durgunluk, hayranlık gözyaşları, küçük ama bağlı hissetme',
    emoji: '✨',
  ),
  GranularEmotion(
    id: 'sur_inspired',
  ...
  GranularEmotion(
    ...
    nameTr: 'Duygulanmış',
    descriptionEn:
        'A deep emotional response to something beautiful, kind, or meaningful.',
    descriptionTr:
        'Güzel, nazik veya anlamlı bir şeye derin bir duygusal yanıt.',
    bodySensationEn: 'Tears welling, warmth in chest, catch in throat',
    bodySensationTr:
        'Gözyaşlarının birikmesi, göğüste sıcaklık, boğazda düğümlenme',
    emoji: '🥹',
  ),
  ...
  GranularEmotion(
    ...
    nameTr: 'Huzurlu',
    descriptionEn:
        'A quiet stillness where nothing needs to be fixed, achieved, or worried about.',
    descriptionTr:
        'Hiçbir şeyin düzeltilmesi, başarılması veya endişelenilmesi gerekmeyen sessiz bir dinginlik.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Güvende',
    descriptionEn:
        'A deep sense of security — physical, emotional, or relational.',
    descriptionTr:
        'Derin bir güvenlik duygusu — fiziksel, duygusal veya ilişkisel.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Rahatlamış',
    descriptionEn:
        'The release of tension after a stressful situation passes or resolves.',
    descriptionTr:
        'Stresli bir durum geçtikten veya çözüldükten sonra gerginliğin bırakılması.',
  ...
  GranularEmotion(
    ...
    nameTr: 'Akışta',
    descriptionEn:
        'Complete absorption in an activity where challenge meets skill perfectly.',
    descriptionTr:
        'Meydan okumanın beceriyle mükemmel bir şekilde buluştuğu bir aktiviteye tam dalış.',
