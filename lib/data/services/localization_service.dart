...
class L10n {
  ...
  static final Map<String, Map<AppLanguage, String>> _translations = {
    ...
    'enter_birth_info_kabbalah': {
      AppLanguage.en:
          'Enter your birth information\nto see your wisdom chart',
      AppLanguage.tr:
          'Bilgelik haritanızı görmek için\nönce doğum bilgilerinizi girin',
      AppLanguage.el:
          'Εισάγετε τα στοιχεία γέννησής σας\nγια να δείτε τον χάρτη σοφίας σας',
      AppLanguage.bg:
          'Въведете данните си за раждане\nза да видите картата си на мъдростта',
      AppLanguage.ru:
          'Введите данные о рождении\nчтобы увидеть вашу карту мудрости',
      AppLanguage.zh: '输入您的出生信息\n查看您的智慧图表',
      AppLanguage.fr:
          'Entrez vos informations de naissance\npour voir votre carte de sagesse',
      AppLanguage.de:
          'Geben Sie Ihre Geburtsdaten ein\num Ihre Weisheits-Karte zu sehen',
      AppLanguage.es:
          'Ingrese su información de nacimiento\npara ver su carta de sabiduría',
      AppLanguage.ar: 'أدخل معلومات ميلادك\nلرؤية مخطط الحكمة الخاص بك',
    },
