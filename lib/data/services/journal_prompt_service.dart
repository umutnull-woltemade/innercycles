...
class JournalPromptService {
  ...
  static const List<JournalPrompt> allPrompts = [
    ...
    JournalPrompt(
      ...
      promptTr: 'Bu hafta kendiniz hakkında sizi şaşırtan bir şey öğrendiniz mi?',
    ...
    JournalPrompt(
      ...
      promptTr: 'Kendinizi gerçekten kendiniz gibi hissettiğiniz bir anı düşünün. Ne yapıyordunuz?',
      category: PromptCategory.selfDiscovery,
    ...
    JournalPrompt(
      ...
      promptTr: 'Sizin için en önemli değerler nelerdir ve günlük eylemleriniz bunları nasıl yansıtıyor?',
      category: PromptCategory.selfDiscovery,
    ...
    JournalPrompt(
      ...
      promptTr: 'Genç kendinize bir tavsiye verebilseydiniz ne söylemeniz gerekirdi?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Kendinizle konuşma şekliniz hakkında ne fark ediyorsunuz? Nazik mi, eleştirici mi?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Güçlü bir şekilde inandığınız bir şeyi düşünün. Nereden geldi ve hala size hizmet ediyor mu?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi aktiviteler zaman kavramını kaybetmenize neden oluyor? Bunlar sizin hakkında ne ortaya koyuyor?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'En son ne zaman konfor alanınızın dışına çıktınız? Nasıl hissettiniz?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hayatınızda tekrar eden hangi kalıpları fark ediyorsunuz? Size ne öğretmeye çalışıyor olabilirler?',
      category: PromptCategory.selfDiscovery,
      depth: PromptDepth.deep,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Çatışmaları nasıl ele aldığınızı düşünün. Yaklaşımınız hakkında ne fark ediyorsunuz?',
      category: PromptCategory.relationships,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Anlamlı bir bağlantı sizin için neye benziyor? Onu nasıl besliyorsunuz?',
      category: PromptCategory.relationships,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Son zamanlarda değişen bir ilişkinizi düşünün. Bu değişimden ne öğrendiniz?',
      category: PromptCategory.relationships,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi sınırları belirlemek sizin için en zor? Onları zorlaştıran ne?',
      category: PromptCategory.relationships,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Birinin size beklenmedik bir şekilde iyilik gösterdiğini yazın. Sizi nasıl etkiledi?',
      category: PromptCategory.relationships,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Grup ortamlarında hangi rolü üstlenme eğiliminde olursunuz? Doğal mı yoksa zoraki mi hissediyorsunuz?',
      category: PromptCategory.relationships,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Aklınızdan çıkamayan bir konuşmayı düşünün. Sizce neden önemli?',
      category: PromptCategory.relationships,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Başkalarının sizin hakkında anlamasını isteyip de nadiren ifade ettiğiniz şey ne?',
      category: PromptCategory.relationships,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Size en yakın insanlara sevgi ve ilginizi nasıl gösteriyorsunuz?',
      category: PromptCategory.relationships,
      depth: PromptDepth.surface,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Bugün size bir an huzur veya mutluluk getiren üç küçük şeyi sayın.',
    ...
    JournalPrompt(
      ...
      promptTr: 'Sonunda büyümenize yardımcı olan bir zorluğunuzu düşünün. O deneyimde neye minnettarsınız?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bugün bedeninizin veya sağlığınızın hangi kısmı için minnettar hissediyorsunuz? Size ne yapmanıza izin verdiğini düşünün.',
      category: PromptCategory.gratitude,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Sizi güvenli ve minnettar hissettiren bir yeri yazın. Onu özel kılan ne?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Genellikle hafife aldığınız basit bir konforu düşünün. Onsuz hayat nasıl olurdu?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hayatınızda son zamanlarda teşekkür etmediğiniz biri kim? Ona ne söylemeniz gerekirdi?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Minnettar olduğunuz bir beceri veya yeteneğiniz nedir? Onu nasıl geliştirdiniz?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hayatınızın zor bir dönemini düşünün. Beklenmedik hangi hediyeleri getirdi?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Sizi her zaman gülümseten bir anıyı düşünün. Neden bu kadar sıcaklık taşıyor?',
      category: PromptCategory.gratitude,
      depth: PromptDepth.deep,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Bugün en güçlü hissettiğiniz duygu neydi? Bedeninizde nerede hissettiniz?',
    ...
    JournalPrompt(
      ...
      promptTr: 'Bir duyguyu bastırdığınız bir zamanı düşünün. Onu ifade etseydiniz ne olmasından korkuyordunuz?',
      category: PromptCategory.emotions,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Üzüntü sizin için nasıl hissettiriyor? Genellikle ona nasıl tepki verdiğinizi düşünün.',
      category: PromptCategory.emotions,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Kaygınızı en sık ne tetikler? Bu durumlar hakkında ne fark ediyorsunuz?',
      category: PromptCategory.emotions,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Siz mutluluk hissettiğinizde, nasıl ortaya çıkar? Kendinizi tamamen yaşamanıza izin veriyor musunuz?',
      category: PromptCategory.emotions,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi duyguyla başa çıkmak sizin için en zor? Ona izin vermek nasıl görünürdü?',
      category: PromptCategory.emotions,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Geçen hafta boyunca ruh halinizin nasıl değiştiğini düşünün. Hangi kalıpları fark ediyorsunuz?',
      category: PromptCategory.emotions,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Şu anda hissettiğiniz bir duyguya bir mektup yazın. Ona ne söylemek isterdiniz?',
      category: PromptCategory.emotions,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Sizi sakin hissettiren nedir? Size huzur getiren duyumları, yerleri veya insanları listeleyin.',
      category: PromptCategory.emotions,
      depth: PromptDepth.surface,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Bugün sizin için önemli olan bir şeye doğru atabileceğiniz küçük bir adım nedir?',
    ...
    JournalPrompt(
      ...
      promptTr: 'Bir zamanlar ulaştığınız bir hedefi düşünün. Sizi oraya götüren iç güçleriniz nelerdi?',
      category: PromptCategory.goals,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi hayali erteliyorsunuz? Sizi geri tutan ne olduğunu fark ediyor musunuz?',
      category: PromptCategory.goals,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bir yıl sonra ideal gününüzü hayal edin. Detaylı olarak tanımlayın.',
      category: PromptCategory.goals,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi alışkanlık oluşturmak istersiniz? Bugün başlayabileceğiniz en küçük versiyonu ne olurdu?',
      category: PromptCategory.goals,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Başarının sizin için kişisel olarak ne anlama geldiğini düşünün, başkalarına göre değil. Onu nasıl tanımlarsınız?',
      category: PromptCategory.goals,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Şu anda ne öğreniyorsunuz veya ne öğrenmek istiyorsunuz? Neden sizi çekiyor?',
      category: PromptCategory.goals,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bir şeyde başarısız olduğunuz bir zamanı yazın. O deneyim size azim hakkında ne öğretti?',
      category: PromptCategory.goals,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Bu ay başardığınız ne kadar küçük olursa olsun üç şeyi listeleyin.',
      category: PromptCategory.goals,
      depth: PromptDepth.surface,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Kendinizi affetmeniz gereken bir şey nedir? Yazın ve bırakmayı düşünün.',
    ...
    JournalPrompt(
      ...
      promptTr: 'İyileşmeye başlayan bir yarayı düşünün. Sürece ne yardımcı oldu?',
      category: PromptCategory.recovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Şu anda öz bakım sizin için neye benziyor? İhmal ettiğiniz bir şey var mı?',
      category: PromptCategory.recovery,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Acı veren bir anıyı düşünün. O anda kendinizle konuşabilseydiniz hangi teselli sunardınız?',
      category: PromptCategory.recovery,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Dinlenme sizin için gerçekten ne anlama geliyor? Ne sıklıkla kendinize gerçek dinlenme izni veriyorsunuz?',
      category: PromptCategory.recovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Taşıdığınız ağır bir şey hakkında yazın. Onu bırakmak nasıl hissettirir?',
      category: PromptCategory.recovery,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Bedeninizin stresi nasıl tuttuğunu düşünün. Gerilimi nerede hissediyorsunuz ve size ne söylüyor olabilir?',
      category: PromptCategory.recovery,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Kendiniz hakkında yeniden yazmaya hazır olduğunuz eski bir hikaye nedir?',
      category: PromptCategory.recovery,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Sizi güvenli hissettiren bir şeyi adlandırın. Hayatınıza daha fazlasını nasıl katabilirsiniz?',
      category: PromptCategory.recovery,
      depth: PromptDepth.surface,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Hiçbir zorunluluğunuz olmayan bir gününüz olsaydı, yaratıcı olarak nasıl geçirirdiniz?',
    ...
    JournalPrompt(
      ...
      promptTr: 'Her zaman merak ettiğiniz ama hiç denemediğiniz yaratıcı uğraş nedir?',
      category: PromptCategory.creativity,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bir şey yarattığınızda kendinizi canlı hissettiğiniz bir anı düşünün. Deneyim nasıldı?',
      category: PromptCategory.creativity,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Gizli bir kapı keşfeden bir karakter hakkında kısa bir sahne yazın. Kapı nereye açılıyor?',
      category: PromptCategory.creativity,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'İç eleştirmeniniz yaratıcılığınız hakkında ne diyor? Bu sese nasıl karşılık verebilirsiniz?',
      category: PromptCategory.creativity,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Pencerenizin dışındaki dünyayı beş duyunuzu kullanarak tanımlayın.',
      category: PromptCategory.creativity,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
    ...
    JournalPrompt(
      ...
      promptTr: 'Yaratıcı ifadenizi nelerin engellediğini düşünün. O engeli aşmak için ne gerekir?',
      category: PromptCategory.creativity,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bugünün ruh halinize uygun bir renk hakkında yazın. Neden bu renk?',
      category: PromptCategory.creativity,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hiçbir sınırlama olmadan herhangi bir şey yaratabileceğinizi hayal edin. Ne yapardınız ve kimin için olurdu?',
      category: PromptCategory.creativity,
      depth: PromptDepth.deep,
    ),
    ...
    JournalPrompt(
      ...
      promptTr: 'Durun ve üç derin nefes alın. Şu anda bedeninizde ne fark ediyorsunuz?',
    ...
    JournalPrompt(
      ...
      promptTr: 'Bugün tamamen şu anda olduğunuz bir anı düşünün. Bunu ne mümkün kıldı?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Hangi düşünceler zihninizde dönüp duruyor? Onları yargılamadan gözlemleyebilir misiniz?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Şu anda duyabildiğiniz sesleri tanımlayın. Hangileri rahatlatıcı?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Zihniniz sessiz olduğunda nasıl hissediyorsunuz? Bunu en son ne zaman yaşadınız?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Bugün otomatik pilotta yaptığınız bir şeyi düşünün. Onu bilinçli olarak yapmak nasıl olurdu?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Artık size hizmet etmeyen neye tutunuyorsunuz? Fark edip nefes alabilir misiniz?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.deep,
    ),
    JournalPrompt(
      ...
      promptTr: 'Her gün gördüğünüz ama nadiren gerçekten baktığınız bir şey hakkında yazın. Detaylı tanımlayın.',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.surface,
    ),
    JournalPrompt(
      ...
      promptTr: 'Aktiviteler arasında nasıl geçiş yaptığınızı düşünün. Acele mi ediyorsunuz, yoksa bir duraklama izni veriyor musunuz?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.medium,
    ),
    JournalPrompt(
      ...
      promptTr: 'Her göreve acelecilik yerine merakla yaklaşsaydınız gününüz nasıl görünürdü?',
      category: PromptCategory.mindfulness,
      depth: PromptDepth.deep,
    ),
  ];
