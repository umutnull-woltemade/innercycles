...
class HoroscopeTemplates {
  ...
  static const List<String> _generalOpeningsTr = [
    ...
    'Sabır bugün önemli bir tema olabilir.',
    ...
    'İç huzur bugün odaklanılabilecek bir tema.',
    ...
    'Kariyer odaklı düşünceler için iyi bir gün.',
  ...
  static const List<String> _generalOpeningsEn = [
    ...
    'Consider how patience serves you in challenging situations.',
    ...
    'A good time to nurture your inner peace and calm.',
    ...
    'A theme for reflection: your professional aspirations.',
  ...
  static const List<String> _loveAdviceTr = [
    ...
    'Sevgi dolu anlar için güzel bir gün.',
  ...
  static const List<String> _loveAdviceEn = [
    ...
    'Consider what romantic gestures mean to you.',
    ...
    'A good time to seek clarity about what you value in relationships.',
    ...
    'Reflect on the emotional support in your life.',
  ...
  static const List<String> _careerAdviceTr = [
    ...
    'İş arkadaşlarından destek teması öne çıkıyor.',
  ...
  static const List<String> _careerAdviceEn = [
    ...
    'Consider how colleagues can support your goals.',
    ...
    'New opportunities in work life may be worth exploring.',
  ...
  static const List<String> _healthAdviceTr = [
    ...
    'Enerji dengesi için iyi bir gün.',
    'Doğada vakit geçirmek güzel olabilir.',
    ...
    'Fiziksel aktivite motive edici olabilir.',
    ...
    'Zihinsel berraklık için güzel bir gün.',
  ...
  static const List<String> _healthAdviceEn = [
    ...
    'Consider practices that balance your energy.',
    'Spending time in nature can be rejuvenating.',
    ...
    'Physical activity can be motivating.',
    ...
    'Consider practices that support mental clarity.',
