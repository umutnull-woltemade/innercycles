...
class CityData {
  ...
  String get displayName =>
      region != null ? '$name, $region ($country)' : '$name ($country)';
...
class WorldCities {
  static const List<CityData> allCities = [
    ...
    // ===== IZMIR (30 ILCE) =====
    CityData(name: 'İzmir', country: 'Türkiye', lat: 38.4192, lng: 27.1287),
    CityData(
      name: 'Aliaga',
      country: 'Türkiye',
      region: 'İzmir',
    ...
    // ===== SANLIURFA (13 ILCE) =====
    CityData(name: 'Şanlıurfa', country: 'Türkiye', lat: 37.1591, lng: 38.7969),
    CityData(
      name: 'Akcakale',
      country: 'Türkiye',
      region: 'Şanlıurfa',
    ...
    // ===== ESKISEHIR (14 ILCE) =====
    CityData(name: 'Eskişehir', country: 'Türkiye', lat: 39.7767, lng: 30.5206),
    CityData(
      name: 'Alpu',
      country: 'Türkiye',
      region: 'Eskişehir',
    ...
    CityData(name: 'Elazığ', country: 'Türkiye', lat: 38.6810, lng: 39.2264),
    // ===== KOCAELI (12 ILCE) =====
    ...
    CityData(name: 'Aydın', country: 'Türkiye', lat: 37.8560, lng: 27.8416),
    CityData(name: 'Balıkesir', country: 'Türkiye', lat: 39.6484, lng: 27.8826),
    CityData(name: 'Tekirdağ', country: 'Türkiye', lat: 40.9833, lng: 27.5167),
    // ===== TRABZON (18 ILCE) =====
    ...
    // ===== MUGLA (13 ILCE) =====
    CityData(name: 'Muğla', country: 'Türkiye', lat: 37.2153, lng: 28.3636),
    CityData(
      name: 'Bodrum',
      country: 'Türkiye',
      region: 'Muğla',
    ...
    CityData(name: 'Ağrı', country: 'Türkiye', lat: 39.7191, lng: 43.0503),
    ...
    CityData(name: 'Bingöl', country: 'Türkiye', lat: 38.8854, lng: 40.4966),
    ...
    CityData(name: 'Çanakkale', country: 'Türkiye', lat: 40.1553, lng: 26.4142),
    CityData(name: 'Çankırı', country: 'Türkiye', lat: 40.6013, lng: 33.6134),
    CityData(name: 'Çorum', country: 'Türkiye', lat: 40.5506, lng: 34.9556),
    CityData(name: 'Düzce', country: 'Türkiye', lat: 40.8438, lng: 31.1565),
    ...
    CityData(name: 'Gümüşhane', country: 'Türkiye', lat: 40.4386, lng: 39.5086),
    CityData(name: 'Hakkari', country: 'Türkiye', lat: 37.5833, lng: 43.7333),
    CityData(name: 'Iğdır', country: 'Türkiye', lat: 39.9237, lng: 44.0450),
    CityData(name: 'Isparta', country: 'Türkiye', lat: 37.7648, lng: 30.5566),
    CityData(name: 'Karabük', country: 'Türkiye', lat: 41.2061, lng: 32.6204),
    ...
    CityData(name: 'Kırıkkale', country: 'Türkiye', lat: 39.8468, lng: 33.5153),
    CityData(
      name: 'Kırklareli',
      country: 'Türkiye',
      lat: 41.7333,
    ...
    CityData(name: 'Kırşehir', country: 'Türkiye', lat: 39.1425, lng: 34.1709),
    CityData(name: 'Kütahya', country: 'Türkiye', lat: 39.4167, lng: 29.9833),
    CityData(name: 'Muş', country: 'Türkiye', lat: 38.9462, lng: 41.7539),
    CityData(name: 'Nevşehir', country: 'Türkiye', lat: 38.6939, lng: 34.6857),
    CityData(name: 'Niğde', country: 'Türkiye', lat: 37.9667, lng: 34.6833),
    ...
    CityData(name: 'Şırnak', country: 'Türkiye', lat: 37.5164, lng: 42.4611),
    ...
    CityData(name: 'Uşak', country: 'Türkiye', lat: 38.6823, lng: 29.4082),
    ...
    CityData(
      name: 'Grand Cayman',
      country: 'Cayman Adalari',
      lat: 19.3133,
      lng: -81.2546,
    ),
    CityData(
      name: 'Turks and Caicos',
      country: 'Turks ve Caicos',
      lat: 21.6940,
      lng: -71.7979,
    ),
    CityData(
      name: 'Virgin Islands',
      country: 'ABD Virgin Adalari',
      lat: 18.3358,
      lng: -64.8963,
    ),
    CityData(
  ...
  static List<CityData> search(String query) {
    ...
    results.sort((a, b) {
      ...
      if (aIsMajor && bIsMajor) {
        return _majorCitiesOrder
            .indexOf(a.name)
            .compareTo(_majorCitiesOrder.indexOf(b.name));
      }
  ...
  static List<CityData> get turkishCities {
    return allCities
        .where((city) => city.country == 'Türkiye' || city.country == 'KKTC')
        .toList();
  }
