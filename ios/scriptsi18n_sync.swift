...
final class I18nSync {
    ...
    private func ruleBasedTranslate(_ text: String, to locale: String) -> String {
        ...
        let mappings: [String: String] = [
            ...
            "restore": "Geri yükle",
            "purchases restored successfully!": "Satın alımlar başarıyla geri yüklendi!",
    ...
    private func finalize() -> Int32 {
        ...
        if errors.isEmpty && modifications.isEmpty {
            print("✅ All localizations are synchronized")
        ...
        if !modifications.isEmpty {
            ...
            if mode == .check {
                print("\n❌ CI CHECK FAILED: Localizations are out of sync")
                print("Run: swift scripts/i18n_sync.swift --sync")
                print(String(repeating: "=", count: 60))
                return 1
            } else {
                print("\n✅ Localizations synchronized")
            }
        }
